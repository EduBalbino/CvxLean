...
noncomputable def A5 : Matrix (Fin 4) (Fin 4) ℝ :=
  fun i j =>
    let arr := #[#[ 0.51417013, -1.40067196,  0.71943208,  0.58510080],
...
noncomputable def b5 : Fin 4 → ℝ :=
  fun i =>
    let arr := #[ 10.56567387,  21.07609985,  23.43361457,  15.14706378]
    arr[i.val]!

@[optimization_param]
noncomputable def c5 : Fin 4 → ℝ :=
  fun i =>
    let arr := #[ 0.14794342, -0.19493149,  0.31361829,  1.13959857]
    arr[i.val]!
